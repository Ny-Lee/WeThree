...
<div class="w3-row" id=data>
    <?php
        ...
        $result = mysqli_query($conn, "SELECT quantity, dateTime, `Order`.totalPrice FROM `Order` INNER JOIN Sales ON `Order`.salesId = Sales.salesId WHERE `Order`.customerId = '$userid'");
    ...
    ?>
        ...
        ?> 
                <div class="column1">
                    <h4>Order#</h4>
                    <h5><b>Quantity:</b></h5>
                    <h5><b>Date Purchased:</b></h5>
                    <h5><b>Total Price:</b></h5>
                </div>
                <div class="column2">
                    <h4><?php echo $i; ?></h4>
                    <h5><b><?php echo $rows[$i]['quantity']; ?></b></h5>
                    <h5><b><?php echo $rows[$i]['dateTime']; ?></b></h5>
                    <h5><b><?php echo $rows[$i]['totalPrice']; ?></b></h5>
                </div>
        </div>
    <?php
        }
