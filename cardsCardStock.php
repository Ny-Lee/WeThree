...
<div class="w3-main" style="margin-left:250px">
    ...
    <header class="w3-container w3-xlarge">
        <p class="w3-left">Cards & Card Stock</p>
        <p class="w3-right">
...
<!-- Product grid -->
<div class="w3-row w3-grayscale" id=data>
    <?php
        $result = mysqli_query($conn, "SELECT * FROM Product WHERE category = 'Card'");
                ...
                <div class="w3-container">
                    <div class="w3-display-container">
                        ...
                        <div class="w3-display-middle w3-display-hover">
                            <button type="submit" class="w3-button w3-black" onclick="document.getElementById('id01'+<?php echo $i; ?>).style.display='block'" style="width=auto;">Buy now <i class="fa fa-shopping-cart"></i></button>
                        </div>
