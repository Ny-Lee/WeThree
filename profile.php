...
<div class="w3-row" id=data>
    <?php
        ...
        $result = mysqli_query($conn, "SELECT * FROM Customer INNER JOIN Account ON Customer.customerId = Account.customerId INNER JOIN Address ON Account.customerId = Address.customerId WHERE Customer.customerId = '$userid'");
        $row = mysqli_fetch_assoc($result);
    ?>
        <div class="row">
            <br>
            <h4 class="h4">Profile Information</h4>
            <hr>
            <div class="column1">
                <h5><b>Name</b></h5>
                <h5><b>Email</b></h5>
            ...
            <div class="column3">
                <br><br><br><br><br>
                <label class="editbtn" onclick="document.getElementById('id01').style.display='block'">EDIT</label>
            </div>
        </div>
</div>
...
<div id="id01" class="modal">
    <form class="modal-content animate" action="changePwd.php" method="get">
        <h3 style="padding-left:20px; padding-top:10px;">Change Password</h3>
        <div class="container">
        ...
        <div class="container" style="background-color:#f1f1f1">
            ...
            <button type="submit" name="submit" class="loginbtn">Update</button>
        </div>
    </form>
</div>
